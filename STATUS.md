...
mod:          Soft Warm Primitive Beds Renew
packageId:    nelim.softwarmprimitivebedsrenew
repo:         Rimworld-Soft-Warm-Primitive-Beds-Renew
visibility:   public
detached:     no
stage:
licence:      silent
licence_at:   five places; Phaneron's own mod declares nothing either
...
# Soft Warm Primitive Beds Renew — status
